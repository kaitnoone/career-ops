...
const CANONICAL_STATES = ['Networking', 'Evaluated', 'Applied', 'Responded', 'Interview', 'Offer', 'Rejected', 'Discarded', 'SKIP'];
...
function validateStatus(status) {
  ...
  const aliases = {
    // Spanish → English
    'pipeline': 'Networking', 'intro': 'Networking', 'warm-contact': 'Networking',
