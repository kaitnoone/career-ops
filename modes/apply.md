...
Interactive mode for when the candidate is filling out an application form in Chrome. Reads what's on screen, loads the prior offer context, and generates tailored answers for each form question.
...
- Or tell us company + role so we can look it up
