...
3. **Pick primary target**: the person who would benefit most from the candidate being there
...
4. **Generate message** with a 3-sentence framework adapted to contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: Specific challenge the team faces (extracted from JD, company blog, or news)
   ...
   - **Sentence 2 (Connection)**: Something the candidate is working on in the same space (NOT a job pitch)
